...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~tA54Qrty6uaxbeOtxM2T", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
BAD_WORDS: process.env.BAD_WORDS || "true, pussy, anus, idiot", // Add Yours Separated by Comma(will be deleted if ANTIBAD is set to true)
